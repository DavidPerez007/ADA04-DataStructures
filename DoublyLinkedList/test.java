public class test {
    public static void main(String[] args) {
        ...
        try {
            list.insertarOrdenadoAscendente(8);
            list.insertarOrdenadoAscendente(12);
            list.insertarOrdenadoAscendente(44);
            list.insertarOrdenadoAscendente(1);
            list.displayList();
            System.out.println(list.peekFirstnode());
            System.out.println(list.peekLastnode());
